...
public class RandomMalesActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_random_males);
        randomUsers = new ArrayList<>();

        recyclerView = findViewById(R.id.rvRandomMales);
        ...
        new Thread(new Runnable()
        {
            ...
            public void run()
            {
                RetrofitHelper.getRandomMales().enqueue(new Callback<RandomResponse>()
                {
                    @Override
