...
public class RandomFemalesActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_random_females);

        gender = getIntent().getStringExtra("gender");
        randomUsers = new ArrayList<>();

        recyclerView = findViewById(R.id.rvRandomFemales);
        ...
        new Thread(new Runnable()
        {
            ...
            public void run()
            {
                RetrofitHelper.getRandomFemales().enqueue(new Callback<RandomResponse>()
                {
                    @Override
